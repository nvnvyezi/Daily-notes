...
Cache-Control: public 指可以公有缓存， 可以是数千名用户共享的。[·](http://caibaojian.com/http-cache.html#t11)

Cache-Control: private 指只支持私有缓存， 私有缓存是单个用户专用的。

![](/media/nvnvyezi/linux_software/linux-web/web-note/http缓存/2012112022535767.png)
...
那可能就有人会问我咋知道是那种缓存，　别急，我们知道浏览器和服务器交互的时候会发送一些请求数据和响应数据，我们称为ｈｔｔｐ报文，报文包括ｈｅａｄｅｒ和部分ｂｏｄｙ，在ｈｅａｄｅｒ中就有我们需要的东西．



![1531214595325](/tmp/1531214595325.png)
...
**看完上面应该对ｈｔｔｐ怎么缓存有一个大概认识了，那接下来我们详细看看缓存相关的首部字段的含义**
