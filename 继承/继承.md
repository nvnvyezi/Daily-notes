我们都知道继承是最让人开心的事了，想想不用动手就能享受父辈的成果。真让人开心。

那显而易见，老李家的孩子不可能继承邻居老王的财产，除非一种情况，　Ｏ（∩＿∩）Ｏ～呵呵，

![](/media/nvnvyezi/linux_software/linux-web/web-note/继承/images.jpeg)

这是为什么呢？当然是因为亲情关系了。

言归正传，在js的世界中想要继承，肯定也存在着一种关系。

那就让我们先来看看这层关系！！！

在[原型](https://blog.csdn.net/nvnv_yezi/article/details/81953015)篇中我们知道。由于ｊｓ里皆对象，所以`__proto__`属性也就人人都有.而这就形成了类似`null--->object.prototype.__proto__--->function.prorotypr.__proto__`的链条。

好的，来个列子

![1535191182419](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535191182419.png)
...
![1535202380185](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535202380185.png)
...
![1535205453432](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535205453432.png)
...
![1535205521455](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535205521455.png)
...
![1535206073841](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535206073841.png)

![1535206115464](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535206115464.png)

从图看出，Ｐｓ和Ｐｆ之间已经没有联系了，Ｐｓ直接继承`Object.prototype`
...
![1535248477692](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535248477692.png)
...
![1535249697322](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535249697322.png)
...
![1535253214859](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535253214859.png)
...
![1535257654738](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535257654738.png)
...
![1535264497254](/media/nvnvyezi/linux_software/linux-web/web-note/继承/1535264497254.png)
